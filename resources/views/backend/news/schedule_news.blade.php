                      ...
                      <table class="table table-striped">
                        ...
                        @if ($news->count())
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.news', $news_items->id) }}" class="btn btn-secondary"><i class="fas fa-pen"></i></a>
                            ...
                            @endforeach
                            {{-- if schedule news not here then show this message --}}
                        @else
                        <tr>
                            <td colspan="5" class="text-center text-muted">Schedule list is empty.</td>
                        </tr>
                        @endif
